                ...
                <div className="nk-block-head nk-block-head-sm">
                    <div className="nk-block-between">
                        <div className="nk-block-head-content">
                            <h3 className="nk-block-title page-title">Admin Dashboard</h3>
                        ...
                        <div className="nk-block-head-content">
                            <div className="toggle-wrap nk-block-tools-toggle">
                                <a href="#" className={`btn btn-icon btn-trigger toggle-expand me-n1 ${isExpand ? 'active' : ''}`} data-target="pageMenu" onClick={toggleExpand} ><em className="icon ni ni-more-v"></em></a>
                                <div className={`toggle-expand-content ${isExpand ? 'expanded' : ''}`} data-content="pageMenu">
